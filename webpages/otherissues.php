...
<?php
    ...
    if(!empty($_POST['submit'])){
        ...
        $help=$_POST['describe_issue'];
        $userid= $_SESSION['userid'];
        $username=$_SESSION['username'];
        $email=$_SESSION['email'];
        $query="INSERT INTO issue_type ( Issue, user_id, user_name, e_mail) VALUES ( '$help','$userid', '$username', '$email') ";
...
<html>
<head>
    <title>OtherIssues</title>
    <link rel="stylesheet" type="text/css" href="handf.css">
    <link rel="stylesheet" type="text/css" href="otherissues.css">
...
<p class = "p3" >Please describe your issue</p>
<form method="post">
    <textarea name="describe_issue" placeholder = "Your message should be less than 250 words..."></textarea> 
    <br><br> 
    <center>
    <input   type="submit" name="submit" value="Submit" class="button" style="vertical-align:middle">
    </center>
   <hr>
</form>
