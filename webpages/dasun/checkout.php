...
<div class="section1">
    ...
    <form method="post">
        <div class="topic">Billing Details</div>  
        <div class="topic1">Order Summary</div><br><br>
        <div class="subtopic1"><u><b>Payment Method</b></u></div><br>
        <div class="radio_buttons">
            <input type="radio" name="payment" value="CreditCard/DebitCard" required>Credit Card/Debit Card      
            <input type="radio" name="payment" value="CashonDelivery" required>Cash on Delivery
        </div>
