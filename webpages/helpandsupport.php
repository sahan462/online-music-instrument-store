...
<?php 
    ...
    if(!empty($_POST['submit'])){
        ...
        if($help=="Other_Issues"){
            
            header('location:otherissues.php');
        }
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="helpandsupport.css">
...
<p class = "p3" >How We Can Help You?</p>
    ...
    <div  class = "box">
        ...
        <form method="post">  
        <p class ="p4">
        <input type="radio" name="help" value="Buying Items"> Buying Items<br>
