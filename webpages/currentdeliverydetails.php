...
<html>
<head>
    <title>Current Delivery Details</title>
    <link rel="stylesheet" type="text/css" href="handf.css">
    <link rel="stylesheet" type="text/css" href="currentdeliverydetails.css">
...
<div class="section">
   <a href="deliverydetails.php"> <input class="btn1"  type="submit" value="Change Delivery Details "></a>
   <a href="checkout.php"> <input class="btn2"  type="submit" value="Next "></a>
        <table border="1">
            <tr>
                <td>First Name :</td>
                <td>Damitha</td>
            ...
            <tr>
                <td>E-mail :</td>
                <td>sahanchandrasena462@gmail.com</td>
            </tr>
            <tr>
                <td>zip-code :</td>
                <td>71500</td>
